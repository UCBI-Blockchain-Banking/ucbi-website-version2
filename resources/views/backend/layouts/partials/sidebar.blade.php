...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{url('/admin')}}">
        <div class="sidebar-brand-icon rotate-n-15">
            <img src="{{asset('public/assets/img/32x32.png')}}" alt="">
        </div>
        <div class="sidebar-brand-text mx-3">UCBI Admin </div>
    </a>
...
{{--    </li>--}}
    ...
    {{-- <li class="nav-item {{ Request::is('admin/contact') ? 'active' : '' }} ">
        <a class="nav-link" href="{{route('admin.all.subscriber')}}">
            <i class="fas fa-fw fa-arrow-right"></i>
...
{{--    </li>--}}
    ...
    <li class="nav-item {{ Request::is('admin/token-sales') ? 'active' : '' }} {{ Request::is('admin/token-sales/token-info') ? 'active' : '' }}">
        ...
        <div id="settings" class="collapse {{ Request::is('admin/token-sales') ? 'show' : '' }} {{ Request::is('admin/token-sales/token-info') ? 'show' : '' }} " aria-labelledby="settings" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item {{ Request::is('admin/token-sales') ? 'active' : '' }}" href="{{route('admin.token-sales')}}"><i class="fas fa-fw fa-user"></i>Contributions</a>
                <a class="collapse-item {{ Request::is('admin/token-sales/token-info') ? 'active' : '' }}" href="{{route('admin.token-info')}}"><i class="fas fa-fw fa-arrow-right"></i> Token Info</a>
            </div>
        </div>
    </li>
