...
{{--                class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>--}}
    ...
    <div class="col-lg-12">
        ...
        {{-- <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-primary shadow h-100 py-2 pointer" onclick="location.href=''">
                <div class="card-body">
        ...
        <!-- Earnings (Monthly) Card Example -->
        {{-- <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-success shadow h-100 py-2 pointer" onclick="location.href=''">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                        ...
                        <div class="col mr-2">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{$all_message}} </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-auto">
