                        ...
                        <div class="card-body">
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea  id="details" class="form-control summernote" cols="30" rows="3" name="details">{{old('details')}}</textarea>
                                    @error('details')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea  id="meta_descrip" class="form-control summernote" cols="30" rows="3" name="meta_descrip">{{old('meta_descrip')}}</textarea>
                                    @error('meta_descrip')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
