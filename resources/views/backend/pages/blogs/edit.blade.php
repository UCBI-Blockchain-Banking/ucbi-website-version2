                ...
                <div class="card-body">
                    <div class="row gx-3 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <img src="{{url('public/uploads/blogs/'.$blogs->image)}}" width="50" alt="">
                            @error('image')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-12 mb-3">
                            <label class="small mb-1" for="tags">Tags <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="tags" name="tags" value="{{$blogs->tags}}">
                            @error('tags')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-12 mb-3">
                            <label class="small mb-1" for="meta_title">Meta title <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="meta_title" name="meta_title" value="{{$blogs->meta_title}}">
                            @error('meta_title')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-12 mb-3">
                            <label class="small mb-1" for="meta_descrip">Meta Description</label>
                            <textarea  id="meta_descrip" class="form-control summernote" cols="30" rows="3" name="meta_descrip">{!! $blogs->meta_descrip !!}</textarea>
                            @error('meta_descrip')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-12 mb-3">
                            <label class="small mb-1" for="meta_keywords">Meta Keyword <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="meta_keywords" name="meta_keywords" value="{{$blogs->meta_keywords}}">
                            @error('meta_keywords')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
