    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 mb-3">
                <form action="{{route('admin.blogs.date')}}" method="get">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-2">
                            <button type="submit" class=" btn  mt-4 btn-primary">Filter Date</button>
                        </div>
                    </div>
                </form>
            </div>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table text-center table-striped table-hover table-bordered" id="dataTablee" width="100%" cellspacing="0">
                                <thead>
                                <tr>
                                    <th>SL</th>
                                    <th>Category</th>
                                ...
                                <tr>
                                    ...
                                    <td><img width="100" src="{{url('public/uploads/blogs/'.$blog->image)}}" alt=""></td>
                                    <td>{{$blog->title}}</td>
