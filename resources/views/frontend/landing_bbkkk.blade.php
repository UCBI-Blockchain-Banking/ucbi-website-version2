...
<div class="hero-area1" style="background: #112d50;">
    <div class="container">
      <div class="row align-items-center justify-content-center">
        <div class="col-lg-8">
          <div class="main-heading text-center">
            <h1 class="text-white">UCBI <br> Blockchain Data Banking <br>    </h1>
            <div class="space16"></div>
            <p style="color: #eee !important;" data-aos="fade-right text-white" data-aos-duration="1000">Union of Cryptocurrencies and Blockchain International </p>
